<template>
    <div>
        ...
        <el-row :gutter="20">
            ...
            <el-col :span="6"><div class="grid-content ep-bg-purple" />
                <el-input v-model="class_number" placeholder="Type something"/>
            </el-col>
            <el-col :span="6"><div class="grid-content ep-bg-purple" /></el-col>
        </el-row>
        <el-row :gutter="20">
            <el-col :span="6"><div class="grid-content ep-bg-purple" /></el-col>
            <el-col :span="6"><div class="grid-content ep-bg-purple" />教室类型：</el-col>
            <el-col :span="6"><div class="grid-content ep-bg-purple" />
                <el-input v-model="class_type" placeholder="Type something"/>
            </el-col>
            <el-col :span="6"><div class="grid-content ep-bg-purple" /></el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <el-row :gutter="20">
            ...
            <el-col :span="6"><div class="grid-content ep-bg-purple" />
                <el-input v-model="other_requirement" placeholder="Type something"/>
            </el-col>
            <el-col :span="6"><div class="grid-content ep-bg-purple" /></el-col>
        </el-row>
        <el-row :gutter="20">
